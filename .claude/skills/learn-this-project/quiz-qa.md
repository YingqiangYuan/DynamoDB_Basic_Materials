...
`profile_name` once in `dynamodb_basic_opeartions/one/one_03_boto_ses.py`. See
...
### Q4. Why do all table names in this project start with `dynamodb_basic_opeartions_`?
...
table whose name begins with `dynamodb_basic_opeartions_` and deletes them after
