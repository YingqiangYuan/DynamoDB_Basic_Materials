...
6. **Tutor mode.** For each prerequisite the user wants to learn:
   ...
   - Connect back: "Here's where you'd apply this in dynamodb_basic_opeartions: <component> at `path/file.ts:NN`."
